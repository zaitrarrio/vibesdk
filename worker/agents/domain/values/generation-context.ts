...
import { FileTreeNode, TemplateDetails } from '../../../services/sandbox/sandbox-types';
import { CodeGenState, FileState, PhaseState } from '../../core/state';
import { DependencyManagement } from '../pure/dependency-management';
import type { StructuredLogger } from '../../../logger';
import { FileProcessing } from '../pure/file-processing';
